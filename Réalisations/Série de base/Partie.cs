...
{
    /// <summary>
    /// Réalisation de l'interface IPartie. Cette classe devrait être la solution par défaut.
    /// </summary>
    class Partie : IPartie
    {
        ...
        /// <summary>
        /// Créé un dictionnaire contenant tout les rôles en Key, et 0 en Value, si la partie est en attente de joueur.
        /// </summary>
        ...
        public void AjouterJoueur(ulong userID)
        {
            ...
            {
                (JoueursEnAttente as List<IJoueur>).Add(Core.Factory.Instance.NouveauJoueur(userID));
                Chrono();
            }
        }
        ...
        {
            return GuildID == other.GuildID && Channel == other.Channel;
        }
        ...
        internal Partie(ulong guildID, ulong channel)
        {
            GuildID = guildID;
            Channel = channel;
            Automatique = true;
